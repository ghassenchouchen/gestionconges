...
import 'package:pfeconges/ui/space/edit_space/bloc/edit_space_event.dart';
import 'package:pfeconges/ui/space/edit_space/bloc/edit_space_state.dart';
...
void main() {
  ...
  group("Edit space test", () {
    ...
    test("Delete space success test", () async {
      ...
      await untilCalled(spaceService.deleteSpace(
          spaceId: "space-id", owners: ["uid"], uid: 'uid'));
      verify(spaceService.deleteSpace(
              spaceId: "space-id", owners: ['uid'], uid: 'uid'))
          .called(1);
